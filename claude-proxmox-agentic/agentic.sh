...
#    curl -fsSL https://raw.githubusercontent.com/FugginOld/code-projects/main/claude-proxmox-agentic/agentic.sh -o /tmp/agentic.sh && bash /tmp/agentic.sh
#
#  GitHub: https://github.com/FugginOld/code-projects/tree/main/claude-proxmox-agentic
# ============================================================================
set -euo pipefail
